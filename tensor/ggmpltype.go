...
var ggmlTypes = map[GGMLType]TypeInfo{
	...
	UNSUPPORTED_Q4_2: {math.MaxInt32, 1},
	UNSUPPORTED_Q4_3: {math.MaxInt32, 1},
	Q5_0:             {math.MaxInt32, 1},
	Q5_1:             {math.MaxInt32, 1},
	Q8_0:             {FLOAT16_BYTES + 32, 32},
	Q8_1:             {32 + 2*4, 32},
	Q2_K:             {math.MaxInt32, 1},
	Q3_K:             {math.MaxInt32, 1},
	...
	Q8_K:             {math.MaxInt32, 1},
	IQ2_XXS:          {math.MaxInt32, 1},
	IQ2_XS:           {math.MaxInt32, 1},
	IQ3_XXS:          {math.MaxInt32, 1},
	IQ1_S:            {math.MaxInt32, 1},
	IQ4_NL:           {math.MaxInt32, 1},
	IQ3_S:            {math.MaxInt32, 1},
	IQ2_S:            {math.MaxInt32, 1},
	IQ4_XS:           {math.MaxInt32, 1},
	I8:               {1, 1},
	I16:              {2, 1},
	I32:              {4, 1},
	I64:              {8, 1},
	F64:              {8, 1},
	IQ1_M:            {math.MaxInt32, 1},
	BF16:             {BFLOAT16_BYTES, 1},
	Q4_0_4_4:         {FLOAT16_BYTES + 16, 32},
	Q4_0_4_8:         {FLOAT16_BYTES + 16, 32},
	Q4_0_8_8:         {FLOAT16_BYTES + 16, 32},
	TQ1_0:            {math.MaxInt32, 1},
	TQ2_0:            {math.MaxInt32, 1},
}
